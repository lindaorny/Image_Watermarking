function img_jpegcompression = func_jpeg_compression(I);
...
img_jpegcompression = K;
%----------------------------------------------------------
%Display of Results
%----------------------------------------------------------
% figure(1);imshow(I1);imwrite(I1,'I1.jpg');title('original image');
% figure(2);imshow(K);imwrite(K,'K.jpg');title('restored image from dct');