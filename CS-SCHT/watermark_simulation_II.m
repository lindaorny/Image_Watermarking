...
% ----------
imwrite(uint8(Mwk_1sts),'cs-scht.bmp');
...
figure;
I0          = imresize(I0,[1024,1024]);
csscht_watermarked = imread('cs-scht.bmp');
csscht_img = imresize(csscht_watermarked,[1024,1024]);

PSNR = func_psnr(uint8(I0),uint8(csscht_img));
...
img_PSNR = insertText(uint8(csscht_watermarked), [450 900], txt_str,'FontSize',70);
ax = subplot(122);
